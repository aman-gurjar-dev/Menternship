  ...
  return (
    <>
      <div className="h-auto sm:h-screen bg-[#1A171E] text-white min-w-screen relative overflow-hidden">
        ...
        {/* content  */}
        <div className=" w-60 sm:w-auto mt-10 relative z-10 mb-25 sm:mb-0">
          <div className=" flex flex-col sm:flex-row sm:justify-evenly items-center justify-center space-y-8">
            <span className=" flex flex-col relative left-[17vw] sm:left-0">
            ...
            <span className=" flex flex-col relative left-[17vw] sm:left-0">
              <img src={ai} alt=" Web dev" className=" w-54 " />
              <NavLink
                to="/Explore_ai"
                className=" p-2 px-7 rounded-3xl bg-[#e3a7eb17] text-center mt-5 "
              >
            ...
            <span className=" flex flex-col relative left-[17vw] sm:left-0 sm:bottom-4 ">
              <img src={ds} alt=" Web dev" className=" w-50" />
              <NavLink
                to="/Explore_ds"
                className=" p-2 px-7 rounded-3xl bg-[#e3a7eb17] text-center mt-5"
              >
